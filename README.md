...
```javascript
incrnanmape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmape@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmape = require( 'path/to/vendor/umd/stats-incr-nanmape/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmape@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nanmape.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nanmape

[test-image]: https://github.com/stdlib-js/stats-incr-nanmape/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nanmape/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nanmape/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nanmape?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nanmape.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nanmape/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nanmape/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nanmape/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nanmape/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nanmape/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nanmape/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nanmape/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nanmape/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nanmape/main/LICENSE
